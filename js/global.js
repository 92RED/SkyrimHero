...
// Lato font from Google's server.
	  WebFontConfig = {
...
$(document).ready(function(){
    $(window).load(function() {$("#loading").fadeOut('fast'); $("#navigator").fadeTo('fast',1); $("header").fadeTo('fast',1); $("#page").fadeTo('fast',1); $("#homepage").fadeTo('fast',1); })
});
/**
 * @summary     DataTables
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" title="Filter search results" placeholder="Filter search results" />' : sSearchStr+' <input type="text" />';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label>'+'<strong>Filters:</strong>'+sSearchStr+'</label>';
